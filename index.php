...
<body>
  <div class="wrapper">
        ...
        <div class="container">
          <div class="header__wrap">
            <div class="header__type">
              <a href="#"><img src="<?php echo get_template_directory_uri() . '/'; ?>assets/imgs/icons/condey.svg" alt="" />
                Кондиционирование</a>
              <a href="#">
    ...
    <main class="main">
          ...
          <div class="about__body">
            <div class="about__text">
              ...
              <div class="text">
                ...
                <div class="quote">
                  <p>Наш девиз:</p>
                  <span>Понятно, экономически доступно, быстро и предельно
                    качественно.</span>
                </div>
                <p>
      ...
      <!-- блок гарантии конец-->
      <?php $review_items = CFS()->get('review_items'); ?>

      <?php if (isset($review_items)) {
      ?>
        ...
        <section class="review">
          <div class="container big-container">
            ...
            <div class="review__wrap">
              <div class="swiper-pagination review-pagination standart-pagination"></div>
              <div class="review__slider swiper">
                <div class="review__slider-wrapper swiper-wrapper">
                  <?php foreach ($review_items as $review_item) : ?>

                    <a data-fancybox="review" href="<?php echo $review_item['review_item'] ?>" class="review__slider-slide swiper-slide">
                      <img src="<?php echo $review_item['preview_item'] ?>" alt="" />
                    </a>
                  ...
                  <a data-fancybox="review" href="<?php echo get_template_directory_uri() . '/'; ?>assets/imgs/sample-5s.mp4" class="review__slider-slide swiper-slide" href="#">
      ...
      <!-- наши работы старт -->
      <?php $works_items = CFS()->get('works_items'); ?>
      <?php if (isset($works_items)) {
      ?>
      ...
      <section class="partners">
        <div class="container big-container">
          ...
          <div class="partners__wrap">
            ...
            <div class="swiper-pagination part-pagination standart-pagination"></div>
          ...
          <div class="footer__col">
            ...
            <div class="col">
              <div class="footer__type">
                <a href="#"><img src="<?php echo get_template_directory_uri() . '/'; ?>assets/imgs/icons/condey.svg" alt="" />
                  Кондиционирование</a>
                <a href="#"><img class="rotate" src="<?php echo get_template_directory_uri() . '/'; ?>assets/imgs/icons/air.svg" alt="" />
                  Вентиляция</a>
              </div>
